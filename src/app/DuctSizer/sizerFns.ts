...
export function getGiSubWeight1(
  ...
  let returnval =
    +((ductQnty1 / divisor) * 0.2 * 0.578) +
    +((ductQnty1 / divisor) * 0.8 * 0.459);
  ...
  if (ducttype == 'SS Rectangle') {
    returnval =
      +((ductQnty1 / divisor) * 0.2 * 0.635) +
      +((ductQnty1 / divisor) * 0.8 * 0.476);
  }

  // amount

  let amt =
    +((ductQnty1 / divisor) * 0.2) *
    +(obj.Factory_fabricated * 0.25 + +obj.Factory_fabricated);
  let amt1 =
    +((ductQnty1 / divisor) * 0.2 * 0.11) *
    +(obj.Material_Wastage * 0.25 + +obj.Material_Wastage);
  let amt2 = +((ductQnty1 / divisor) * 0.8) * +obj.Factory_fabricated;
  let amt3 = +((ductQnty1 / divisor) * 0.8 * 0.11) * +obj.Material_Wastage;
  let amt4 = +((ductQnty1 / divisor) * 0.8) * +obj.mm13_thick_Nitrile;
  let amt5 = +((ductQnty1 / divisor) * 0.2) * +obj.mm10_Nitrile_Rubber;
  ...
  if (ducttype == 'Preinsulated') {
    ...
    amt1 = +((ductQnty1 / divisor) * 0.11) * +obj.Material_Wastage_11;
    amt2 = +0;
    amt3 = +0;
    amt4 = +0;
    amt5 = +0;
...
export function getGiSubWeight2(
  ...
  let returnval =
    +((ductQntyR1 / divisor) * 0.2 * 0.578) +
    +((ductQntyR1 / divisor) * 0.8 * 0.459);
...
export function getGiConsting(
  ...
  return {
    Rectangle: getGiSubCosting(
      ...
      airFlow,
      ductQnty.Rectangle,
      ductWeight.Rectangle.AMOUNT,
      ductWeight.Rectangle.WEIGHT,
      unit,
    ),
    Oval: getGiSubCosting(
      OVAL_PARAMS,
      floorArea,
      airFlow,
      ductQnty.Oval,
      ductWeight.Oval.AMOUNT,
      ductWeight.Oval.WEIGHT,
      unit,
    ),
    Spiral: getGiSubCosting(
      ...
      airFlow,
      ductQnty.Spiral,
      ductWeight.Spiral.AMOUNT,
      ductWeight.Spiral.WEIGHT,
      unit,
    ),
    Preinsulated: getGiSubCosting(
      ...
      airFlow,
      ductQnty.Preinsulated,
      ductWeight.Preinsulated.AMOUNT,
      ductWeight.Preinsulated.WEIGHT,
      unit,
    ),
    Fabric: getGiSubCosting(
      ...
      airFlow,
      ductQnty.Fabric,
      ductWeight.Fabric.AMOUNT,
      ductWeight.Fabric.WEIGHT,
      unit,
    ),
    'SS Rectangle': getGiSubCosting(
      ...
      airFlow,
      ductQnty['SS Rectangle'],
      ductWeight['SS Rectangle'].AMOUNT,
      ductWeight['SS Rectangle'].WEIGHT,
      unit,
    ),
  };
}
